      ...
      <div class="row">
         <div class="col-md-4 mx-auto">
            <div class="myform form ">
               <form action="<?php echo base_url();?>Emp/save_emp" method="post" >
                  ...
                  <div class="form-group">
                     <input type="salary" name="salary" required class="form-control my-input" id="salary"  value="<?php echo @$res_data['salary'];?>"placeholder="Salary">
                  </div>
