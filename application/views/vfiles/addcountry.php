    ...
    <div class=" mx-auto col-md-5">
      <div class="card shadow-lg bg-white">
       <div class="card-header bg-info">
            <h2 class="card-title text-center font-weight-bolder text-uppercase text-white-50">Country Name</h2>
            
        </div>
       
        <div class="card-body">
	    <form action="<?php echo base_url();?>Country/save_country" method="post" >
            
            <div class="form-group">
                <label for="uname" class="font-weight-bold">Country name:</label>
                <input type="text" class="form-control" id="countryname" placeholder="Enter name" name="country_name" value="<?php echo @$res_data['country_name']; ?>" required>
