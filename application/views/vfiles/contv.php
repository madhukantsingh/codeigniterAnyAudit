...
<body>
<h2>Controller  <span style=""> <a href="<?php echo base_url();?>Controllers/addcontroller"> Add  </a> </span> </h2>
 
<h3><a style = 'margin-left: 1150px; ' href="<?php echo base_url();?>Sag_cont"> Back to Home </a></h3>
 
<h3><a style = 'margin-left: 1150px; ' href="<?php echo base_url();?>Bharath/index"> Back to Home </a></h3>
...
<?php if(!empty($all_list)) { 
        foreach($all_list as $key=>$val){ 
          ...
          <tr>
            ...
            <td><?php echo @$val['controller_desc'];?></td>
